========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLPKS Project Overview
========================================================================

AppWizard has created this ATLPKS project for you to use as the starting point for
...
ATLPKS.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLPKS.h)
        GUID definitions                                (ATLPKS_i.c)
        A type library                                  (ATLPKS.tlb)
        Marshaling code                                 (ATLPKS_p.c and dlldata.c)

ATLPKS.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLPKS.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLPKS.pch and a precompiled types file named StdAfx.obj.
...
ATLPKSps.vcxproj
	...
	dlldata.c, ATLPKS_i.c and ATLPKS_p.c which are required
	to build the proxy/stub DLL.

ATLPKSps.vcxproj.filters
